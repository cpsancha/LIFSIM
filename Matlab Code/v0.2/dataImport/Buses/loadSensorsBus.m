...
elems(4).Name = 'OmegaMeas_body';
elems(4).Dimensions = 1;
elems(4).DimensionsMode = 'Fixed';
elems(4).DataType = 'Bus: OmegaMeasBus';
...
elems(5).Name = 'DCMMeas_body_earth';
