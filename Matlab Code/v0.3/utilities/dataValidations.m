...
checks.consistentLength   = 1;    %Value of the flag in the case of consistent length
checks.inconsistentLength = 0;    %Value of the flag in the case of inconsistent length, must be greater than ConsistentLength
